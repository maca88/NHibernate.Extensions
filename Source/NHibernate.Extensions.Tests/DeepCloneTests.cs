...
namespace NHibernate.Extensions.Tests
{
    ...
    public class DeepCloneTests : BaseIncludeTest
    {
        ...
        [TestMethod]
        public async Task deep_clone_async_simple_properties()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_as_reference_and_ignore_properties_identifiers()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_references()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_collections()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_filter()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_with_skip_entity_types()
        {
            EQBPerson clone;
            EQBPerson petra;
        ...
        [TestMethod]
        public async Task deep_clone_async_without_identifier()
        {
            EQBPerson clone;

            using (var session = NHConfig.OpenSession())
            {
                var petra = await session.Query<EQBPerson>()
                    .Include(o => o.IdentityCard)
                    .Include(o => o.BestFriend.IdentityCard)
                    .Include(o => o.CurrentOwnedVehicles.First().Wheels)
                    .Include(o => o.CurrentOwnedVehicles.First().RoadworthyTests)
